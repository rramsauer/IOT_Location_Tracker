/** @file uwb_anchor.cpp
 * @brief This file provides a UWB-Anchor
 *  ****************************************************************
 *        **Name**            : uwb_anchor.cpp
 *  <br>  **Project name**    : 
...
/**
 * @brief This function init the uwb module as a Anchor.
 *
 * This function init the uwb modul Dakewave DW1000 as a Anchor.
 *
 * @date                18.02.2023
 *
 * @version             V0.1
...
void initUwb()
{
    ...
    // Start as Anchor
    DW1000Ranging.startAsAnchor(ADRESS, DW1000.MODE_LONGDATA_RANGE_LOWPOWER, false);
    ...
    DW1000.setAntennaDelay(ATENNEN_DELAY);
}
...
/**
 * @brief This function is called when a new distance of a anchor is measured.
 *
...
void newRange()
{
    writeMeasuringDataToSeriel(DW1000Ranging.getDistantDevice()->getPrintableShortAddress(),DW1000Ranging.getDistantDevice()->getRange(),DW1000Ranging.getDistantDevice()->getRXPower());
}
...
{
    Log.verboseln("NEW UWB BLINK: %lX", device->getPrintableShortAddress());
}
